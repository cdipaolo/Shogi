...
-(void) touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if (self.gameOverShowing){
        ...
        if (piece > 0 && piece < GOLD && indicesI<3 && pieceI>2){
            ...
            // do minimax for enemy move
            Minimax* findBestMove = [[Minimax alloc] initWithBoard:self.board depth:5];
        ...
        OnePlayerScene* scene = [[OnePlayerScene alloc] initWithSize:self.size];
        [self.view presentScene:scene];
